...
**Project:** User Cohorts & Personalised Video Recommendations  
...
### The Core Challenge
A short video platform has thousands of videos and hundreds of thousands of users. Showing every user the same feed ignores individual taste. The goal is to show each user the videos they are most likely to watch, like, and share.

### Three Sub-Problems We Solve
